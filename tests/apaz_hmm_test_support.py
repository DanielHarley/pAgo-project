"""Test support for the APAZ profile-HMM builder.
...
or reference-tree module, so the APAZ HMM tests run without requiring any of
that unrelated surface to be present.
"""
